...
public class Wrench extends Actor {
    ...
    public Wrench(Stage canvas) {
        super(canvas);
        sprites = new String[]{imgLoc + "1.png", imgLoc + "2.png", imgLoc + "3.png", imgLoc + "4.png", imgLoc + "5.png", imgLoc + "6.png", imgLoc + "7.png", imgLoc + "8.png", imgLoc + "9.png", imgLoc + "10.png", imgLoc + "11.png", imgLoc + "12.png"};
        width = 45;
        height = 45;
        frameSpeed = 10;
    }
